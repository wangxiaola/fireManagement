...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[_photoDataArray objectAtIndex:indexPath.row] isKindOfClass:[UIImage class]]){
        UIImage *photo = [_photoDataArray objectAtIndex:indexPath.row];
        [browerCell loadPicData:photo];
    }
