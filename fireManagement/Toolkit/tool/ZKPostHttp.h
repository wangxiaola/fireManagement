...
/**
 ...
 @param failure 失败回调Block
 */
+ (void)post:(NSString *)url params:(NSDictionary *)params cacheType:(ZKCacheType)cacheType success:(void (^)(NSDictionary *obj))success failure:(void (^)(NSError *error))failure;
