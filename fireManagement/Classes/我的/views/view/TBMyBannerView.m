...
- (UIImageView *)headerImageView
{
    if (!_headerImageView)
    {
        _headerImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Group_upload"]];
...
- (UIView *)backImageView
{
    if (!_backImageView)
    {
        ...
        gradient.colors = [NSArray arrayWithObjects:
                           (id)NAVIGATION_COLOR.CGColor,
                           (id)RGB(255, 74, 49).CGColor,
                           (id)RGB(255, 90, 63).CGColor, nil];
        [_backImageView.layer addSublayer:gradient];
        _backImageView.backgroundColor = RGB(255, 90, 63);
